...
- [Node.js:](https://nodejs.org/en)<script src='https://cdn.jsdelivr.net/gh/eddymens/markdown-external-link-script@v2.0.0/main.min.js'></script> only LTS versions are supported v21 or higher. The easier way to install [nvm](https://github.com/nvm-sh/nvm#installing-and-updating) is here.
- [pnpm](https://pnpm.io/installation)<script src='https://cdn.jsdelivr.net/gh/eddymens/markdown-external-link-script@v2.0.0/main.min.js'></script> (latest version) to run the erxes. 
- [mongodb](https://www.mongodb.com/docs/manual/installation/)<script src='https://cdn.jsdelivr.net/gh/eddymens/markdown-external-link-script@v2.0.0/main.min.js'></script> 
- [redis](https://redis.io/docs/latest/operate/oss_and_stack/install/archive/install-redis/)<script src='https://cdn.jsdelivr.net/gh/eddymens/markdown-external-link-script@v2.0.0/main.min.js'></script> 
- [Docker](https://www.digitalocean.com/community/tutorials/how-to-install-and-use-docker-on-ubuntu-20-04)<script src='https://cdn.jsdelivr.net/gh/eddymens/markdown-external-link-script@v2.0.0/main.min.js'></script> If needed
</Tab>
  <Tab label="MacOS">
- [Git](https://github.com/git-guides/install-git)<script src='https://cdn.jsdelivr.net/gh/eddymens/markdown-external-link-script@v2.0.0/main.min.js'></script>
- [Node.js:](https://nodejs.org/en)<script src='https://cdn.jsdelivr.net/gh/eddymens/markdown-external-link-script@v2.0.0/main.min.js'></script> only LTS versions are supported v21 or higher. The easier way to install [nvm](https://github.com/nvm-sh/nvm#installing-and-updating) is here.
...
<Note>
If you are not using docker & installed databases you can skip this step
</Note>

1. In the folder, create a dock directory using the following command.
```tsx
mkdir dock
```
2. Go to the dock folder using the following command.
```tsx
cd dock
```


3. Create a `docker-compose.yml` file, then copy the following script into the newly created file.
<Tabs>
  <Tab label="Ubuntu">
```tsx
version: '3.6'
...
4. In the folder where the above file is located, run the following command:
```tsx
...
pnpm install
```
5. Start APIS (backend)

```tsx
pnpm dev:apis
```

6. Start UIS (frontend)
